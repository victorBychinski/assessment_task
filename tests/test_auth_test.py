...
class TestAuthorizationClient:
    ...
    def test_health_endpoint_3(
        ...
        logger.info("Running health endpoint test 3")
        ...
        quote_added = converter_service.create_quote(currency_in=currency_in,
        ...
        assert is_quote_pending(saved_quote), "Quote UUIDs do not match"
        ...
        is_fee_applied_on_amount_out_correct_value_valid(assepted_quote, service_fee)
        ...
        (wallet_in.balance, 
         ...
         precision), "Wallet in balance is not correct after quote acceptance"
        
        assert is_wallet_balance_valid
        (wallet_out.balance, 
         updated_wallet_out.balance, 
         quote_added.amount_out, 
         precision, False), "Wallet out balance is not correct after quote acceptance"
